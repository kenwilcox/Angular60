angular.module('myRoster').controller('RosterController', function ($scope, DataService, GridService) {
  $scope.players = [];
  ...
  var setupGrid = function () {
      $scope.gridRoster = GridService.getOptions();
      // define the "fields"
      $scope.gridRoster.columnDefs = GridService.getColumnDefs();        
  };   
  ...
  $scope.setPlayers = function () {
    ...
    $scope.gridRoster.data = $scope.players;
  }
